...
export class AuthRepository implements IAuthRepository {
  ...
  changeRole(role: string) {
    ...
    window.open(
      `${this.primeApiBaseURL}app/${role}?b_qp_custom=false&i_qp_user_id=${this.auth.user_id}&accountId=${this.auth.account_id}`
    );
  }
}
